...
export const mockWorkstations: Workstation[] = [
  { id: "w1", sector_id: "s1", name: "Operador de Chapa", description: "Chapa industrial para preparo de lanches", activity_description: "Preparo de lanches quentes na chapa industrial", tasks_performed: "Montar lanches, operar chapa, higienizar equipamentos", machines_equipment: "Chapa industrial a gás Vulcan, Coifa de exaustão", tools_accessories: "Espátulas, modeladores de hambúrguer, recipientes de inox", lighting_nho11: "450 lux (Conforme NHO-11)", thermal_comfort_nr17: "28°C (IBUTG)", situations_found: "Trabalho em pé constante, exposição a calor radiante, movimentos repetitivos de membros superiores durante a montagem dos lanches.", insalubridade: "20%", periculosidade: false, work_schedule: "08:00 - 16:00", break_times: "1h almoço + 2 pausas de 15min", created_at: "2025-01-20" },
  { id: "w2", sector_id: "s1", name: "Preparador de Sucos", description: "Bancada de sucos e vitaminas", activity_description: "Preparo de sucos naturais e vitaminas", tasks_performed: "Cortar frutas, operar liquidificador, servir bebidas", machines_equipment: "Liquidificadores industriais, extratores de suco automáticos", tools_accessories: "Facas, tábuas de corte, jarras graduadas", lighting_nho11: "420 lux", thermal_comfort_nr17: "24°C", situations_found: "Manuseio frequente de facas, movimentos repetitivos de braço e ombro, contato com umidade.", insalubridade: "Não", periculosidade: false, work_schedule: "08:00 - 16:00", break_times: "1h almoço", created_at: "2025-01-20" },
  { id: "w3", sector_id: "s2", name: "Atendente de Caixa", description: "Caixa registradora e atendimento", activity_description: "Atendimento ao cliente e operação do caixa", tasks_performed: "Registrar pedidos, receber pagamentos, atender clientes", machines_equipment: "Terminal PDV, Gaveta eletrônica, Pinpad", tools_accessories: "Calculadora, Suporte de notas", lighting_nho11: "520 lux", thermal_comfort_nr17: "23°C", situations_found: "Postura em pé prolongada em espaço reduzido, movimentos repetitivos de digitação e manuseio de valores.", insalubridade: "Não", periculosidade: false, work_schedule: "10:00 - 18:00", break_times: "1h almoço", created_at: "2025-02-01" },
  { id: "w4", sector_id: "s3", name: "Auxiliar de Limpeza", description: "Limpeza geral do estabelecimento", activity_description: "Higienização e conservação do ambiente", tasks_performed: "Varrer, lavar, higienizar equipamentos e banheiros", machines_equipment: "Enceradeira industrial (ocasional)", tools_accessories: "MOP, vassouras, rodos, baldes, panos microfibra", lighting_nho11: "350 lux", thermal_comfort_nr17: "25°C", situations_found: "Contato com agentes químicos de limpeza, superfícies úmidas, flexão de tronco e agachamentos frequentes.", insalubridade: "40%", periculosidade: false, work_schedule: "07:00 - 15:00", break_times: "1h almoço", created_at: "2025-02-05" },
  { id: "w5", sector_id: "s4", name: "Assistente Administrativo", description: "Escritório com estação de trabalho informatizada", activity_description: "Atividades administrativas em escritório", tasks_performed: "Digitação, atendimento telefônico, arquivo de documentos", machines_equipment: "Notebook, Monitor 24\", Impressora multifuncional", tools_accessories: "Telefone IP, Grampeador, Perfurador", lighting_nho11: "500 lux", thermal_comfort_nr17: "22°C", situations_found: "Trabalho sentado prolongado com uso intensivo de computador, digitação e visualização de tela.", insalubridade: "Não", periculosidade: false, work_schedule: "08:00 - 17:00", break_times: "1h almoço", created_at: "2025-02-10" },
...
export const mockRiskAssessments: RiskAssessment[] = mockAnalyses.map((a, i) => {
  ...
  return {
    ...
    description: a.notes,
    hazard: "Posturas desajeitadas e movimentos repetitivos",
    possible_damage: "Lombalgias, Tenossinovites, Fadiga muscular",
    generating_source: "Atividades operacionais e mobiliário",
    exposure_time: i % 2 === 0 ? "Habitual" : "Intermitente",
